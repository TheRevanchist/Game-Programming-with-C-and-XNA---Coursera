...
namespace GameProject
{
    ...
    class NumberBoard
    {
        ...
        // declaring a gameState variable
            ...
            int correctNumber, SoundBank soundBank)
        {
            ...
            for (int i = 0; i < NUM_ROWS; i++)
                ...
                {
                    k++;
                    tiles[i, j] = new NumberTile(contentManager, CalculateTileCenter(i, j), tileSideLength, k, correctNumber, soundBank);
                }
        ...
        public bool Update(GameTime gameTime, MouseState mouse)
        {
            ...
            for (int i = 0; i < NUM_ROWS; i++)
                for (int j = 0; j < NUM_COLUMNS; j++)
                {
                    restart = tiles[i, j].Update(gameTime, mouse);
                    if (restart)
                        return true;
                }
