...
namespace ProgrammingAssignment4
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        // declaring a bool variable that we need for the Update method
        bool play;

        // declaring a QuitButton variable
        QuitButton button;
        ...
        protected override void LoadContent()
        {
            ...
            button = new QuitButton(Content, graphics.PreferredBackBufferWidth / 2, graphics.PreferredBackBufferHeight - 80
                , GameState.Quit);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (gameOver && gameState == GameState.Play)
            {
                button.Visible = true;
