...
namespace ProgrammingAssignment2
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            image1 = Content.Load<Texture2D>("img1");
            image2 = Content.Load<Texture2D>("img2");
            image3 = Content.Load<Texture2D>("img3");
            image4 = Content.Load<Texture2D>("img4");
            image5 = Content.Load<Texture2D>("img5");

            // STUDENTS: set the currentSprite variable to one of your sprite variables
            currentSprite = image1;
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (elapsedTime > CHANGE_DELAY_TIME)
            {
                ...
                {
                    currentSprite = image2;
                }
                else if (spriteNumber == 2)
                {
                    currentSprite = image3;
                }
                else if (spriteNumber == 3)
                {
                    currentSprite = image4;
                }
                else if (spriteNumber == 4)
                {
                    currentSprite = image5;
                }
